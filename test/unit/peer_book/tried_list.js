...
const { TriedList } = require('../../../src/peer_book/tried_list');
const { initializePeerInfoList } = require('../../utils/peers');
const { PEER_TYPE } = require('../../../src/utils');
...
describe('triedPeer', () => {
	...
	describe('#gettriedPeersObj', () => {
		...
		before(async () => {
			...
			triedPeersArray = triedPeersObj.peersList();
		});
